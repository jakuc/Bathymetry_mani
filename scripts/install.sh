#!/bin/bash
# install.sh - konfiguracja nowego sprzętu dla mani_ros
...
echo "========================================"
echo "  mani_ros - instalacja środowiska"
echo "========================================"
...
if ! dpkg -l | grep -q nvidia-container-toolkit 2>/dev/null; then
    ...
    echo "[2/4] nvidia-container-toolkit już zainstalowany - pomijam."
fi
...
echo "========================================"
echo ""
echo "Uruchomienie symulacji Isaac Sim:"
echo "  docker compose -f docker/docker-compose.yml run --rm mani_ros bash"
echo "  # wewnątrz kontenera:"
echo "  cd /workspace && colcon build && ros2 launch xm540_bringup lake_sim.launch.py"
echo ""
echo "Uruchomienie z podpiętym sprzętem (HW):"
echo "  docker compose -f docker/docker-compose.yml -f docker/docker-compose.hw.yml run --rm mani_ros bash"
echo "  # wewnątrz kontenera:"
echo "  ros2 launch xm540_bringup manual.launch.py"
echo ""
